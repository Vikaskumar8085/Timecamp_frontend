...
const ContractorApprovelbilingstatus = () => {
  ...
  const fetchmanagerapprovelbillingstatusfunc = async () => {
    try {
      const response = await apiInstance.get(
        "/v2/contractor/fetch-contractor-dash-approvel-billing-status"
      );
  ...
  useEffect(() => {
    fetchmanagerapprovelbillingstatusfunc();
  }, [0]);
  return (
    <div>
...
export default ContractorApprovelbilingstatus;
