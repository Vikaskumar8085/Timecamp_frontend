...
const ContractorBillingStatusDistribution = () => {
  ...
  const fetchcontractorbillingstatusdistributionfunc = async () => {
    try {
      const response = await apiInstance.get(
        "/v2/contractor/fetch-contractor-dash-billing-status-distribution"
      );
...
export default ContractorBillingStatusDistribution;
