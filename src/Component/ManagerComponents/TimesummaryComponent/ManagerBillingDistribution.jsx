...
const ManagerBillingDistribution = () => {
  ...
  const fetchmanagerbillingdistributionfunc = async () => {
    try {
      const response = await apiInstance.get(
        "/v2/manager/manager-billed-notbilled"
      );
  ...
  useEffect(() => {
    fetchmanagerbillingdistributionfunc();
  }, [0]);
  return (
    <div>
      {" "}
...
export default ManagerBillingDistribution;
